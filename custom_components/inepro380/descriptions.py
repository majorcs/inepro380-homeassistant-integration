...
IDENTITY_SENSORS: tuple[IneproSensorDescription, ...] = (
    ...
    _diagnostic(key="device_current_rating", name="Device current rating", address=0x400B, register_count=1, decoder=decode_uint16, native_unit_of_measurement=str(UnitOfElectricCurrent.AMPERE)),
    _diagnostic(key="current_transformer_ratio", name="Current transformer ratio", address=0x400C, register_count=1, decoder=decode_uint16, native_unit_of_measurement=str(UnitOfElectricCurrent.AMPERE)),
    _diagnostic(key="s0_pulse_ratio", name="S0 pulse ratio", address=0x400D, register_count=2, decoder=decode_float_abcd, native_unit_of_measurement="imp/kWh"),
    ...
    _diagnostic(key="disconnect_counter", name="Disconnect counter", address=0x4016, register_count=1, decoder=decode_uint16),
    _diagnostic(key="quadrant", name="Current quadrant", address=0x4017, register_count=1, decoder=decode_uint16),
    ...
    _diagnostic(key="current_transformer_mode", name="Current transformer mode", address=0x401F, register_count=1, decoder=decode_uint16),
)
...
MEASUREMENT_SENSORS: tuple[IneproSensorDescription, ...] = (
    ...
    _measurement(key="active_power", name="Active power", address=0x5012, native_unit_of_measurement=str(UnitOfPower.KILO_WATT), device_class=SensorDeviceClass.POWER),
    ...
    _measurement(key="reactive_power", name="Reactive power", address=0x501A, native_unit_of_measurement="kvar", device_class=REACTIVE_POWER_DEVICE_CLASS),
    ...
    _measurement(key="apparent_power", name="Apparent power", address=0x5022, native_unit_of_measurement="kVA", device_class=APPARENT_POWER_DEVICE_CLASS),
...
ENERGY_SENSORS: tuple[IneproSensorDescription, ...] = (
    _total(key="total_energy", name="Total energy", address=0x6000, native_unit_of_measurement=str(UnitOfEnergy.KILO_WATT_HOUR), device_class=SensorDeviceClass.ENERGY),
    _total(key="tariff_1_total_energy", name="Tariff 1 total energy", address=0x6002, native_unit_of_measurement=str(UnitOfEnergy.KILO_WATT_HOUR), device_class=SensorDeviceClass.ENERGY),
    _total(key="tariff_2_total_energy", name="Tariff 2 total energy", address=0x6004, native_unit_of_measurement=str(UnitOfEnergy.KILO_WATT_HOUR), device_class=SensorDeviceClass.ENERGY),
    _total(key="l1_total_energy", name="L1 total energy", address=0x6006, native_unit_of_measurement=str(UnitOfEnergy.KILO_WATT_HOUR), device_class=SensorDeviceClass.ENERGY),
    _total(key="l2_total_energy", name="L2 total energy", address=0x6008, native_unit_of_measurement=str(UnitOfEnergy.KILO_WATT_HOUR), device_class=SensorDeviceClass.ENERGY),
    _total(key="l3_total_energy", name="L3 total energy", address=0x600A, native_unit_of_measurement=str(UnitOfEnergy.KILO_WATT_HOUR), device_class=SensorDeviceClass.ENERGY),
    _total(key="import_active_energy", name="Import active energy", address=0x600C, native_unit_of_measurement=str(UnitOfEnergy.KILO_WATT_HOUR), device_class=SensorDeviceClass.ENERGY),
    _total(key="tariff_1_import_active_energy", name="Tariff 1 import active energy", address=0x600E, native_unit_of_measurement=str(UnitOfEnergy.KILO_WATT_HOUR), device_class=SensorDeviceClass.ENERGY),
    _total(key="tariff_2_import_active_energy", name="Tariff 2 import active energy", address=0x6010, native_unit_of_measurement=str(UnitOfEnergy.KILO_WATT_HOUR), device_class=SensorDeviceClass.ENERGY),
    _total(key="l1_import_active_energy", name="L1 import active energy", address=0x6012, native_unit_of_measurement=str(UnitOfEnergy.KILO_WATT_HOUR), device_class=SensorDeviceClass.ENERGY),
    _total(key="l2_import_active_energy", name="L2 import active energy", address=0x6014, native_unit_of_measurement=str(UnitOfEnergy.KILO_WATT_HOUR), device_class=SensorDeviceClass.ENERGY),
    _total(key="l3_import_active_energy", name="L3 import active energy", address=0x6016, native_unit_of_measurement=str(UnitOfEnergy.KILO_WATT_HOUR), device_class=SensorDeviceClass.ENERGY),
    _total(key="export_active_energy", name="Export active energy", address=0x6018, native_unit_of_measurement=str(UnitOfEnergy.KILO_WATT_HOUR), device_class=SensorDeviceClass.ENERGY),
    _total(key="tariff_1_export_active_energy", name="Tariff 1 export active energy", address=0x601A, native_unit_of_measurement=str(UnitOfEnergy.KILO_WATT_HOUR), device_class=SensorDeviceClass.ENERGY),
    _total(key="tariff_2_export_active_energy", name="Tariff 2 export active energy", address=0x601C, native_unit_of_measurement=str(UnitOfEnergy.KILO_WATT_HOUR), device_class=SensorDeviceClass.ENERGY),
    _total(key="l1_export_active_energy", name="L1 export active energy", address=0x601E, native_unit_of_measurement=str(UnitOfEnergy.KILO_WATT_HOUR), device_class=SensorDeviceClass.ENERGY),
    _total(key="l2_export_active_energy", name="L2 export active energy", address=0x6020, native_unit_of_measurement=str(UnitOfEnergy.KILO_WATT_HOUR), device_class=SensorDeviceClass.ENERGY),
    _total(key="l3_export_active_energy", name="L3 export active energy", address=0x6022, native_unit_of_measurement=str(UnitOfEnergy.KILO_WATT_HOUR), device_class=SensorDeviceClass.ENERGY),
    ...
    _total(key="tariff_1_total_reactive_energy", name="Tariff 1 total reactive energy", address=0x6026, native_unit_of_measurement="kvarh", device_class=REACTIVE_ENERGY_DEVICE_CLASS),
    _total(key="tariff_2_total_reactive_energy", name="Tariff 2 total reactive energy", address=0x6028, native_unit_of_measurement="kvarh", device_class=REACTIVE_ENERGY_DEVICE_CLASS),
    ...
    _total(key="import_reactive_energy", name="Import reactive energy", address=0x6030, native_unit_of_measurement="kvarh", device_class=REACTIVE_ENERGY_DEVICE_CLASS),
    _total(key="tariff_1_import_reactive_energy", name="Tariff 1 import reactive energy", address=0x6032, native_unit_of_measurement="kvarh", device_class=REACTIVE_ENERGY_DEVICE_CLASS),
    _total(key="tariff_2_import_reactive_energy", name="Tariff 2 import reactive energy", address=0x6034, native_unit_of_measurement="kvarh", device_class=REACTIVE_ENERGY_DEVICE_CLASS),
    _total(key="l1_import_reactive_energy", name="L1 import reactive energy", address=0x6036, native_unit_of_measurement="kvarh", device_class=REACTIVE_ENERGY_DEVICE_CLASS),
    _total(key="l2_import_reactive_energy", name="L2 import reactive energy", address=0x6038, native_unit_of_measurement="kvarh", device_class=REACTIVE_ENERGY_DEVICE_CLASS),
    _total(key="l3_import_reactive_energy", name="L3 import reactive energy", address=0x603A, native_unit_of_measurement="kvarh", device_class=REACTIVE_ENERGY_DEVICE_CLASS),
    _total(key="export_reactive_energy", name="Export reactive energy", address=0x603C, native_unit_of_measurement="kvarh", device_class=REACTIVE_ENERGY_DEVICE_CLASS),
    _total(key="tariff_1_export_reactive_energy", name="Tariff 1 export reactive energy", address=0x603E, native_unit_of_measurement="kvarh", device_class=REACTIVE_ENERGY_DEVICE_CLASS),
    _total(key="tariff_2_export_reactive_energy", name="Tariff 2 export reactive energy", address=0x6040, native_unit_of_measurement="kvarh", device_class=REACTIVE_ENERGY_DEVICE_CLASS),
    _total(key="l1_export_reactive_energy", name="L1 export reactive energy", address=0x6042, native_unit_of_measurement="kvarh", device_class=REACTIVE_ENERGY_DEVICE_CLASS),
    _total(key="l2_export_reactive_energy", name="L2 export reactive energy", address=0x6044, native_unit_of_measurement="kvarh", device_class=REACTIVE_ENERGY_DEVICE_CLASS),
    _total(key="l3_export_reactive_energy", name="L3 export reactive energy", address=0x6046, native_unit_of_measurement="kvarh", device_class=REACTIVE_ENERGY_DEVICE_CLASS),
    ...
    _total(key="daily_resettable_energy", name="Daily resettable energy", address=0x6049, native_unit_of_measurement=str(UnitOfEnergy.KILO_WATT_HOUR), device_class=SensorDeviceClass.ENERGY, state_class=SensorStateClass.TOTAL_INCREASING, enabled_default=False),
)
